...
List solve_chunk_mb_cpp(
    const Eigen::Map<Eigen::MatrixXd>& X_fixed,           // n × p
    const Eigen::Map<Eigen::MatrixXd>& w_chunk,            // n × G_chunk
    const Eigen::Map<Eigen::MatrixXd>& z_chunk,            // n × G_chunk
    const Eigen::Map<Eigen::MatrixXd>& lam_diag_chunk,    // q × G_chunk
    int q_total,
